...
- `UESTC MOOC/`
  - UESTC MOOC 平台相关工具与分析
- `obsidian同步/`
  - Obsidian 多设备同步方案整理（Git + GitHub 方案分析、自建 CouchDB + LiveSync 实时同步方案）
- `服务器与VPS/`
...
5. 本地大模型运行全链路（llama.cpp 9 章：量化、调优、API、LoRA、多模型管理）
6. GitHub 与开发环境使用、Git 基础操作
7. Linux 基础命令与服务器管理
8. 数学与课程基础笔记（微积分、线性代数）
9. 异构多核音频处理课程笔记
10. CET-6 写作与翻译备考复习（2023-2025真题、句式分类、话题语料、范文）
11. 大学物理电磁学期末复习（静电场、稳恒磁场、电磁波，含公式推导与易错习题）
12. Obsidian 多设备同步方案（Git + GitHub 方案分析、自建 CouchDB + LiveSync 实时同步方案）
