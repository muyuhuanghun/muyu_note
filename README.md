...
- `量化交易入门(X)/`
  ...
  - `入门课程体系/`：全网权威教材与课程调研后整理的量化交易入门课程（13 篇代码驱动笔记：全景图、数据获取、收益率度量、回测陷阱、动量/均值回归策略、Fama-French 多因子、Kelly 仓位管理、交易成本、金融机器学习、实盘部署与书单索引）
- `灵感/`
  - 随手记录的想法与灵感片段
- `obsidian同步/`
...
8. 量化交易入门（Hull《期权、期货及其他衍生品》38 章笔记 + 13 篇入门课程体系：策略、回测、风控、金融 ML 与实盘部署）
